!(function (U, fe) {
  ...
  const U = new Map(),
    ...
    ie = (i) =>
      !(!i || "object" != typeof i) &&
      (void 0 !== i.jquery && (i = i[0]), void 0 !== i.nodeType),
    ae = (i) =>
      ie(i)
        ? i.jquery
          ? i[0]
    ...
    Ce = (i) => {
      ...
      const e =
          "visible" === getComputedStyle(i).getPropertyValue("visibility"),
    ...
    M = (i, e = [], t = i) => ("function" == typeof i ? i(...e) : t),
    fi = (i, e, t = !0) => {
      ...
      let s = !1;
      const o = ({ target: r }) => {
        r === e && ((s = !0), e.removeEventListener(Et, o), M(i));
      };
    ...
    show() {
      ...
      if (
        ...
        (e.length && e[0]._isTransitioning) ||
          l.trigger(this._element, xs).defaultPrevented)
      )
        return;
  ...
  l.on(document, Ds, $t, function (i) {
    ("A" === i.target.tagName ||
      (i.delegateTarget && "A" === i.delegateTarget.tagName)) &&
      i.preventDefault();
  ...
  var $ = "top",
    ...
    ji = "beforeWrite",
    Hi = "afterWrite",
    Wi = [Di, "read", Ii, Ni, "main", Mi, ji, "write", Hi];
  function Z(i) {
  ...
  function he(i) {
    return (
      (me(i) ? i.ownerDocument : i.document) || window.document
    ).documentElement;
  }
  function lt(i) {
    return "html" === Z(i)
      ? i
      : i.assignedSlot || i.parentNode || (Mt(i) ? i.host : null) || he(i);
  }
  function Ri(i) {
    return R(i) && "fixed" !== se(i).position ? i.offsetParent : null;
  }
  function Ue(i) {
    for (var e = H(i), t = Ri(i); t && Ps(t) && "static" === se(t).position; )
      t = Ri(t);
    return t &&
      ("html" === Z(t) || ("body" === Z(t) && "static" === se(t).position))
      ? e
      : t ||
          (function (n) {
            var s = /firefox/i.test(Ft());
            if (/Trident/i.test(Ft()) && R(n) && "fixed" === se(n).position)
              return null;
            var o = lt(n);
            for (
              Mt(o) && (o = o.host);
              R(o) && ["html", "body"].indexOf(Z(o)) < 0;
    ...
    if (d) {
      ...
      w === H(t) &&
        ...
        (s !== I && ((s !== $ && s !== j) || o !== Ie)) ||
          ((y = F),
          (p -=
            (h && w === v && v.visualViewport ? v.visualViewport.width : w[O]) -
            n.width),
          (p *= c ? 1 : -1));
    }
    var T,
      ...
      W =
        !0 === u
          ? ((G = { x: p, y: m }),
            ...
            (K = G.y),
            {
              x: Pe(G.x * (L = N.devicePixelRatio || 1)) / L || 0,
              y: Pe(K * L) / L || 0,
            })
          : { x: p, y: m };
    return (
  ...
  function qt(i) {
    return Me(he(i)).left + Rt(i).scrollLeft;
  }
  function Vt(i) {
    var e = se(i);
  ...
  function Qi(i, e, t) {
    return e === It
      ...
      : me(e)
      ? (((o = Me((n = e), !1, "fixed" === t)).top = o.top + n.clientTop),
        ...
        (ee =
          "clippingParents" === (V = c)
            ? ((P = Qe(lt((x = N)))),
              me(
                (X =
                  ["absolute", "fixed"].indexOf(se(x).position) >= 0 && R(x)
                    ? Ue(x)
                    : x)
              )
                ...
                : [])
            : [].concat(V)),
        (D = (te = [].concat(ee, [K])).reduce(function (x, P) {
          var X = Qi(N, P, L);
          return (
  ...
  const Zi = {
    ...
    fn: function (i) {
      ...
      if (!e.modifiersData[n]._skip) {
        ...
        e.placement !== O &&
          ((e.modifiersData[n]._skip = !0), (e.placement = O), (e.reset = !0));
      }
    },
        ...
        (("body" !== Z(e) || Vt(a)) &&
          (d =
            (n = e) !== H(n) && R(n)
              ...
              : Rt(n)),
        R(e)
          ? (((u = Me(e, !0)).x += e.clientLeft), (u.y += e.clientTop))
          : a && (u.x = qt(a))),
      {
  ...
  var zs = dt(),
    Rs = dt({ defaultModifiers: [zt, Xt, Bt, jt] }),
    Ut = dt({ defaultModifiers: [zt, Xt, Bt, jt, nn, Zi, sn, Ki, tn] });
  ...
  class re extends Y {
    ...
    _addEventListeners() {
      l.on(this._element, ko, (e) => {
        "Escape" === e.key &&
          (this._config.keyboard ? this.hide() : l.trigger(this._element, Sn));
      });
    }
    static jQueryInterface(e) {
      return this.each(function () {
  ...
  l.on(document, xo, '[data-bs-toggle="offcanvas"]', function (i) {
    const e = f.getElementFromSelector(this);
    if ((["A", "AREA"].includes(this.tagName) && i.preventDefault(), le(this)))
      return;
    l.one(e, Dn, () => {
      Ce(this) && this.focus();
    });
      ...
      for (const t of e)
        if ("click" === t)
          ...
          const n = this.constructor.eventName(
              t === Ge ? "mouseenter" : "focusin"
            ),
            s = this.constructor.eventName(
              t === Ge ? "mouseleave" : "focusout"
            );
          l.on(this._element, n, this._config.selector, (o) => {
            ...
            l.on(this._element, s, this._config.selector, (o) => {
              const r = this._initializeOnDelegatedTarget(o);
              (r._activeTrigger["focusout" === o.type ? Jt : Ge] =
  ...
  const ei = ".bs.scrollspy",
    ...
    ti = "[href]",
    Mn = ".nav-link",
    Ko = `${Mn}, .nav-item > ${Mn}, .list-group-item`,
    Xo = {
      offset: null,
